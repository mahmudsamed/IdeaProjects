...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        basson(meyve);
        System.out.println( "/n **********");
        System.out.println(buykuc(meyve));
        System.out.println( "/n **********");
    ...
    public static void basson(List<String> meyve){
    ...
    public static List<String> buykuc(List<String> meyve){

 List<String> sonuc=       meyve.stream().sorted(Comparator.comparing(t->t.toString().length()).reversed()).limit(3).collect(Collectors.toList());
