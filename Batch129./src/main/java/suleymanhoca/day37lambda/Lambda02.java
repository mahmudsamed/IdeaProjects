package suleymanhoca.day37lambda;
...
public class Lambda02 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.lines(Paths.get("Batch129./src/main/java/suleymanhoca/day37lambda/LambdaTextFile")).forEach(System.out::println);

        //2) LambdaTextFile dosyasi icindeki her characteri uppercase yapiniz.
        Files.
                lines(Paths.get("Batch129./src/main/java/suleymanhoca/day37lambda/LambdaTextFile")).
