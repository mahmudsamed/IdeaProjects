...
public class StringBuilder01 { /*
    ...
    public static void main(String[] args) {
        ...
        //toString() method u StringBuilder i Stringe cevirir
        //String classda var olan ama StringBuilder class var olmayan split() method gibi
        //methodlara ihtiyac duydugumuzda toString() methodu kullanarak String Class gecer ve o method laari kullaniriz
...
//deleteCharAt() index 1 deki characteri siler
        sb3.deleteCharAt(1);

        System.out.println(sb3);//oXXXXlF
// index (1,6) index 1 deki characterden index 5(6 dahil olmadigi icin 5 yazdim) deki chaacter e kadar tum characterleri siler
        sb3.delete(1,5);
        System.out.println(sb3);
...
//
     ...
     //sb5.compareto(sb6) methodu sb5 ile sb6 yi alfavbetik siralam olarak karsilatirir
     //sb5.alfabetik siralama da once ise sonuc negative olur,sonra ise sonuc positive olur
