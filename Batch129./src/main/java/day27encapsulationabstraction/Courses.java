...
6)"concrete class" lar "abstract class" larin child'i olabilirler.
  "abstract method" larin override edilme zorunlulugu "concrete class" lar icindir.
    ...
    public  void art(){
        System.out.println("Paintining...");
    }
    // final methodlar override edilemezler halbuki abstract methodlar override edilmek icin olusturulurlar
    //Bu celiskidir bu yuzden Java abstract methodlarin final olmasina musaade etmezler
   // public final abstract void  science();

    //Concrede classlar final oldugunda Child Class a sahip olamazlar
    // Ama Abstract classlar icin Child Class olmalidir,cunku child classlar abstract parent class daki abstract methodlari kullanirlar.
    //Bu yuzden java Abstract Class larin final olmasina musaade etmez

    //Abstract methodlar private olamazlar,cunku child classlar abstract methodlari kullanirlar private yapinca kullanima kapali olur
    //Bu celiskidir, bu yuzden Java abstract methodlarin private olmasina musaade etmez
    //"abstract methodlar static olamazlar,cunku static methodlar override edilemez,halbuki abstract methodlar override edilmek icin olusuturulmustur
