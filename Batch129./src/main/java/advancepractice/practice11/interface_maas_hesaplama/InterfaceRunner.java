...
public class InterfaceRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("maasHesaplaAli.neetMaas(10000,11,160) = " + maasHesaplaAli.neetMaas(10000, 11, 160));

        MaasHesapla maasHesaplaVeli = new MaasHesapla();
        System.out.println("maasHesaplaVeli.neetMaas(10000,1,180) = " + maasHesaplaVeli.neetMaas(10000, 1, 180));

        MaasHesapla maasHesaplaAyse = new MaasHesapla();
        System.out.println("maasHesaplaAyse.neetMaas(10000,15,180) = " + maasHesaplaAyse.neetMaas(10000, 5, 180));
